...
if (result.error) {
  ...
  if (result.features.length >= 1) {
    ...
    const referenceHtml =
    "<i><font size = '1'>" +
    "Estimates from the US Bureau of Economic Analysis, the US Bureau of Labor Statistics, and Utah's Division of Oil, Gas, and Mining. GDP, employment, wages are averages based on current time frame." +
     "</font></i>";
